...
namespace REPO_DeadTTS.Config
{
    ...
    public static class ConfigSettings
    {
        ...
        public static void BindConfigSettings()
        {
            ...
            minRandomPitch = AddConfigEntry(Plugin.instance.Config.Bind("General", "Dead TTS Random Pitch Min", 0.1f, new ConfigDescription("The lower range limit when randomizing dead players pitch.\nValues will be clamped between 0.1 and 2.0", new AcceptableValueRange<float>(0.1f, 2.0f))));
            maxRandomPitch = AddConfigEntry(Plugin.instance.Config.Bind("General", "Dead TTS Random Pitch Max", 1.9f, new ConfigDescription("The upper range limit when randomizing dead players pitch.\nValues will be clamped between 0.1 and 2.0", new AcceptableValueRange<float>(0.1f, 2.0f))));
            ...
            minRandomPitch.Value = Mathf.Clamp(minRandomPitch.Value, 0.1f, 2.0f);
